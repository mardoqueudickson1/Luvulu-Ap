...
exports.PrismaClinicRepositoy = void 0;
const prisma_service_1 = require("../../../prisma/prisma.service");
const common_1 = require("@nestjs/common");
const utils_1 = require("../../../../utils/utils");
const errorsMessages_1 = require("../../../../utils/shared/errorsMessages");
let PrismaClinicRepositoy = class PrismaClinicRepositoy {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async create({ userId, clinicLatitude, cliniclongitude, }) {
    ...
    async findById(userID) {
        try {
            ...
            const responseDoctor = {
                id: clinicInfo.id,
                token: clinicInfo.user.FCMToken[0].token,
                user: {
    ...
    async profile(id) {
        ...
        console.log(...oo_oo(`1300838614_218_4_218_31_4`, clinicResponse));
        return clinicResponse;
    }
    async findClinicId(userID) {
        const clinicInfo = await this.prisma.institution.findUnique({
            where: {
                id: userID,
            },
    ...
    async findAppoitmentByClinicId(instituitionId) {
        try {
            ...
            const appointments = appointmentsData.map((appointment) => {
                return {
                    ...
                    consultationType: {
                        ...
                        name: (0, utils_1.formatName)(appointment.consultationType.name),
                    ...
                    doctor: {
                        ...
                        user: {
                            ...
                            name: (0, utils_1.formatName)(appointment.Doctor.user.name),
                        },
                    },
                    patient: {
                        ...
                        user: {
                            ...
                            name: (0, utils_1.formatName)(appointment.pacient.user.name),
                        },
    ...
    async clinicFilter(filterOptions) {
        try {
            ...
            const result = clinics.map((e) => ({
                services: e.service,
                clinicRating: e.ClinicRating,
                user: {
                    id: e.id,
                    name: (0, utils_1.formatName)(e.user.name),
                    email: e.user.email,
    ...
    async SearchForClinic(name, page) {
        try {
...
exports.PrismaClinicRepositoy = PrismaClinicRepositoy;
exports.PrismaClinicRepositoy = PrismaClinicRepositoy = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], PrismaClinicRepositoy);
;
function oo_cm() { try {
...
;
oo_te;
//# sourceMappingURL=prismaClinicRepository.js.map