...
const update_patient_avatar_service_1 = require("../../../patient/usecases/updateAvatar/update-patient-avatar.service");
...
let UpdateAvatarPatientResolver = class UpdateAvatarPatientResolver {
    ...
    async updatePatientAvatar(file, user) {
        const patientIdLogged = await this.updatePatientAvatarService.getPatientID(user.id);
