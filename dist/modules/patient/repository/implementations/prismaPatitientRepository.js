...
exports.PrismaPatitientRepositoy = void 0;
const prisma_service_1 = require("../../../prisma/prisma.service");
const common_1 = require("@nestjs/common");
const errorsMessages_1 = require("../../../../utils/shared/errorsMessages");
let PrismaPatitientRepositoy = class PrismaPatitientRepositoy {
    constructor(prisma) {
        this.prisma = prisma;
    }
    ...
    async profile(id) {
        try {
            ...
            console.log(...oo_oo(`1519281496_194_6_194_63_4`, user.Patient[0].patientCard.map((e) => e.id)));
            const result = {
            ...
            console.log(...oo_oo(`1519281496_229_6_229_24_4`, error));
            throw new common_1.InternalServerErrorException(errorsMessages_1.messages.errorServer);
        }
    }
    ...
    async changeAppointmentStatus(appointmentId, status) {
        try {
...
exports.PrismaPatitientRepositoy = PrismaPatitientRepositoy;
exports.PrismaPatitientRepositoy = PrismaPatitientRepositoy = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], PrismaPatitientRepositoy);
;
function oo_cm() { try {
...
;
oo_te;
//# sourceMappingURL=prismaPatitientRepository.js.map