...
exports.PrismaUserRepositoy = void 0;
const prisma_service_1 = require("../../../prisma/prisma.service");
const common_1 = require("@nestjs/common");
const errorsMessages_1 = require("../../../../utils/shared/errorsMessages");
let PrismaUserRepositoy = class PrismaUserRepositoy {
    constructor(prisma) {
        this.prisma = prisma;
    }
    ...
    async findByEmail(email) {
        ...
        if (data.FCMToken[0] !== undefined) {
            token = data.FCMToken[0].token;
        }
        if (data.Doctor[0] !== undefined) {
            userID = data.Doctor[0].id;
        }
        if (data.Institution[0] !== undefined) {
            userID = data.Institution[0].id;
        }
        if (data.Patient[0] !== undefined) {
            userID = data.Patient[0].id;
        }
        const result = {
            id: userID,
            userId: data.id,
    ...
    async findById(id) {
        ...
        if (data.FCMToken[0] !== undefined) {
            console.log(...oo_oo(`427445113_182_6_182_42_4`, typeof data.FCMToken[0]));
            token = data.FCMToken[0].token;
        }
        if (data.Doctor[0] !== undefined) {
            userID = data.Doctor[0].id;
    ...
    async findByPacientId(userID) {
        ...
        const responsePacient = {
            id: patient.user.id,
            token: patient.user.FCMToken[0].token,
        };
...
exports.PrismaUserRepositoy = PrismaUserRepositoy;
exports.PrismaUserRepositoy = PrismaUserRepositoy = __decorate([
