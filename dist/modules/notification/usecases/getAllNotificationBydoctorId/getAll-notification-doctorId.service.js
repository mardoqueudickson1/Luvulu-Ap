...
exports.ListAllNotificationByDoctorIdService = void 0;
...
let ListAllNotificationByDoctorIdService = class ListAllNotificationByDoctorIdService {
    constructor(notificationRepo) {
        this.notificationRepo = notificationRepo;
    }
    async listAll(doctorId) {
        const notification = await this.notificationRepo.findAllNotificationDoctorId(doctorId);
        if (!notification) {
...
exports.ListAllNotificationByDoctorIdService = ListAllNotificationByDoctorIdService;
exports.ListAllNotificationByDoctorIdService = ListAllNotificationByDoctorIdService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [INotificaionRepository_1.INotificationRepository])
], ListAllNotificationByDoctorIdService);
//# sourceMappingURL=getAll-notification-doctorId.service.js.map