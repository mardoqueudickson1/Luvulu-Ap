...
export declare abstract class INotificationRepository {
    ...
    abstract findPatientByUserId(id: string): Promise<ResponsePatientLoggedOutput>;
    abstract findDoctorUserId(id: string): Promise<ResponseDoctorOutput>;
    abstract update(id: string, notification: UpdateNotificationInput): Promise<Notifications>;
    abstract findAllNotificationPatientId(patientId: string): Promise<NotificationResponse[]>;
    abstract findAllNotificationClinicId(clinicId: string): Promise<NotificationResponse[]>;
    abstract findAllNotificationDoctorId(doctorId: string): Promise<NotificationResponse[]>;
}
