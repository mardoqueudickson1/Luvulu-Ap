...
export declare abstract class IDoctorRepository {
    abstract create({ userId, registrationNumber, specialty, bio, institutionId, }: CreateDoctorPartial): Promise<Doctors>;
    ...
    abstract associateDoctor(data: AssociateDoctorInput): Promise<AssociateDoctorResponse>;
    abstract isDoctorAssociatedWithClinic(doctorId: string, institutionId: string): Promise<AssociateDoctorResponse>;
    abstract desasociateDoctor(data: AssociateDoctorInput): Promise<{
        message: string;
    }>;
    ...
    abstract DoctorFilter(doctorFilterOptions: DoctorFilterOptions): Promise<TopResponseAllDoctor[]>;
    abstract SearchDoctor(name: string, page: number): Promise<TopResponseAllDoctor[]>;
    abstract getDoctorAppointmentsPatients(id: string): Promise<ResponseAllAppointPatient[]>;
