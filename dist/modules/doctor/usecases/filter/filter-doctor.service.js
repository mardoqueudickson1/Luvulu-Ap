...
exports.FilterDoctorService = void 0;
...
let FilterDoctorService = class FilterDoctorService {
    constructor(doctorRepo) {
        this.doctorRepo = doctorRepo;
    }
    async filterDoctor(data) {
        for (const key in data) {
            const formattedValue = typeof data[key] === 'string'
                ? (0, utils_1.toUpperCase)(data[key])
                : data[key];
...
exports.FilterDoctorService = FilterDoctorService;
exports.FilterDoctorService = FilterDoctorService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [IDoctorRepository_1.IDoctorRepository])
], FilterDoctorService);
//# sourceMappingURL=filter-doctor.service.js.map